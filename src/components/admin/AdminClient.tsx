  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
        ...
        {loading ? (
          <div className="mt-6 text-zinc-200">Loading users…</div>
        ) : rows.length === 0 ? (
          <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-4 text-sm text-zinc-200">
            No users returned. If you just added the Service Role key, restart the dev server and hit Refresh.
          </div>
        ) : (
